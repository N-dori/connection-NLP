...
const  WhatToolsYouGet = React.forwardRef ((props,ref) =>  {
  return (
    ...
    <section className="list-warpper grid">
      ...
      <li className='flex-ac'><DoneSvg />אתה תדע כיצד לשלוט "סטייט" שלךברמה עוצמתית!</li>
      <li className='flex-ac'><DoneSvg />תבין הייטב מה הם עוגנים וכיצד להשתמש בהם בדרך הטובה יותר עם כל אדם!</li>
      <li className='flex-ac'><DoneSvg />תלמד מה היא השפה של המח וממה מורכבת מחשבה.</li>
      <li className='flex-ac'><DoneSvg />נלמד כיצד ניתן לתכנת וליצור תהליכי שינוי עם המודע ותת המודע גם יחד.</li>
      </ul>

      <ul className='group2 flex-col clean'>
      <li className='flex-ac'><DoneSvg />תלמד תבניות שפה מטורפות לחולל שינויים ולהשיג שינויי תודעה ברמה עמוקה מאוד!</li>
      <li className='flex-ac'><DoneSvg />נלמד מה הם אמונות מעצימות ומה הם אמונות מגבילות וכיצד ניתן לחשוף ולשנות אותם!</li>
      <li className='flex-ac'><DoneSvg />אתה תקבל כלים משמעותיים לתהליכי שינוי, החל מאימון אישי להעצמה ולהגשמה בכל תחום, עד לטיפול בחרדות, דיכאונות, טראמות, התמכרויות, וכו'</li>
