  ...
  return (
    <section className='contant-wapper flex'>
        ...
        <section className='course-curriculum flex-sb'>
            ...
            <button onClick={expandAll} className='expend-all-btn flex-ac'>{isAllExpaned?'Expand All Sections':'Collapse All Sections'}</button>
        </section>
       <Panel title={'intro'} isAllExpaned={isAllExpaned} lectures={3}min={27}/>
